...
{var canvas=obj.canvas;var duration=(arguments[1]&&arguments[1].duration?arguments[1].duration:1000);var frames=(arguments[1]&&arguments[1].frames?arguments[1].frames:5);canvas.style.opacity=0;RGraph.Clear(obj.canvas);RGraph.RedrawCanvas(obj.canvas);for(var i=1;i<=frames;++i){setTimeout('document.getElementById("'+canvas.id+'").style.opacity = '+(i*(1/frames)),i*(duration/frames));}
if(typeof(arguments[2])=='function'){setTimeout(arguments[2],duration);}}
RGraph.Effects.Fade.Out=function(obj)
{var canvas=obj.canvas;var duration=(arguments[1]&&arguments[1].duration?arguments[1].duration:1000);var frames=(arguments[1]&&arguments[1].frames?arguments[1].frames:5);RGraph.Clear(obj.canvas);RGraph.RedrawCanvas(obj.canvas);for(var i=frames;i>=0;--i){setTimeout('document.getElementById("'+canvas.id+'").style.opacity = '+(i*(1/frames)),(frames-i)*(duration/frames));}
if(typeof(arguments[2])=='function'){setTimeout(arguments[2],duration);}}
